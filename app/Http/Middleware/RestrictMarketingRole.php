    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($user && $user->role === 'marketing') {
            ...
            $allowedRoutes = [
                ...
                'admin.prompt-generator.customers.history',
                'admin.prompt-generator.history.destroy',
                'admin.prompt-generator.customers.quick-store',
                'admin.prompt-generator.customers.quick-update',
                'admin.prompt-generator.customers.quick-destroy',
