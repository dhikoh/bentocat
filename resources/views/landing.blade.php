            ...
            <div class="max-w-4xl mx-auto bg-white border border-[#e5e0d8]/80 rounded-[2.5rem] group hover:border-amber-500/50 hover:shadow-xl transition-premium p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="md:col-span-5 showcase-container bg-white">
                        ...
                        <div class="badge top-right select-none pointer-events-none">
                            <div class="badge-icon">
                        ...
                        <div class="badge bottom-left select-none pointer-events-none">
                            <div class="badge-icon">
                        ...
                        <div class="badge bottom-right select-none pointer-events-none">
                            <div class="badge-icon">
                        ...
                        @if($product->thumbnail)
                            <img id="showcase-image" src="{{ asset($product->thumbnail) }}" alt="{{ $product->nama }}" class="product-image">
                        @else
                            <span class="text-6xl z-10">🐈</span>
                        @endif

                        <!-- Aroma Text Display -->
                        <div class="aroma-display">
                            <div class="aroma-subtitle">Aroma</div>
                            <div class="aroma-title text-yellow-400" id="aroma-text">LEMON</div>
                        </div>

                        <!-- Aroma Selector Dots -->
                        <div class="aroma-selector" id="aroma-selector">
                            @php
                                $colorMap = [
                                    'lemon' => '#FDE047',
                                    'strawberry' => '#F87171',
                            ...
                            @foreach($aromas as $index => $aroma)
                                @php
                                    ...
                                    $isActive = $index === 0;
                                @endphp
                                <button class="dot {{ $isActive ? 'active' : '' }}" 
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        dots.forEach(dot => {
            dot.addEventListener('click', () => {
                ...
                // Liquid text transition (blur -> change text -> clear blur)
                if (aromaText) {
