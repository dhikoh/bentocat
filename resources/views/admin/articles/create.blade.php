...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div>
        <h1 class="text-2xl font-bold text-white">Tulis Artikel Baru</h1>
        <p class="text-sm text-slate-400">Gunakan editor berbasis blok untuk menyusun konten interaktif.</p>
    </div>

    <form id="article-form" action="{{ route('admin.articles.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        @csrf
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-slate-900/40 border border-slate-800/80 p-6 rounded-3xl space-y-4">
                <div>
                    ...
                    <input type="text" name="title" id="title" required placeholder="Tulis judul artikel yang menarik..." 
                ...
                <div>
                    ...
                    <textarea name="summary" id="summary" rows="2" placeholder="Ringkasan singkat artikel untuk preview halaman depan..." 
                              class="w-full bg-slate-950 border border-slate-800 focus:border-amber-500 rounded-xl px-4 py-2 text-sm text-slate-200 focus:outline-none transition-all"></textarea>
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-slate-900/40 border border-slate-800/80 p-6 rounded-3xl space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="seo_title" id="seo_title" placeholder="Kosongkan untuk menyamakan dengan judul..." 
                ...
                <div>
                    ...
                    <textarea name="seo_description" id="seo_description" rows="3" placeholder="Tulis meta description unik untuk search engine snippet..." 
                              class="w-full bg-slate-950 border border-slate-800 focus:border-amber-500 rounded-xl px-3 py-2 text-xs text-slate-200 focus:outline-none transition-all"></textarea>
                </div>
            </div>
...
<script>
    ...
    // Sync state to hidden input on form submit
